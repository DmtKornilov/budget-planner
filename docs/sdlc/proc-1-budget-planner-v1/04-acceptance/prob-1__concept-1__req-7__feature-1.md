...
As a user, once my receipt is parsed, I want each item automatically sorted into a spending category, so my budget breakdown is meaningful without manual work.
...
- [[prob-1/concept-1/req-7]] — the requirement these scenarios verify
