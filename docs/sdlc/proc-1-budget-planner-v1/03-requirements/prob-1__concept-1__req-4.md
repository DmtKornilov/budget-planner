...
Prevents bad OCR data from silently corrupting the budget, per [[prob-1]]'s stated problem. The specific threshold value is not yet defined (see BRD open question 5, carried forward in [[prob-1]] Open questions) and is deliberately left configurable rather than invented here. Derived from BRD A10.
