...
Category assignment is what turns a list of purchases into a budget breakdown — the core of BR-3 and the reason [[prob-1/concept-1]] chose an LLM API for categorization. Derived from BRD C1.
