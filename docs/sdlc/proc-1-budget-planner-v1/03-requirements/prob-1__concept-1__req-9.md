...
Directly answers `failure-behaviour`: low-confidence classifications should not be presented as if they were certain. Derived from BRD C3. The specific threshold value is not yet defined, consistent with [[prob-1]]'s Open questions.
