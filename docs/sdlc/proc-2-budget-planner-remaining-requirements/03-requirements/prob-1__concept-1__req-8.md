...
This is the primary success signal confirmed for this build ([[prob-1]] Success metrics: adoption and goal engagement depend on users actually seeing a useful monthly total).
