...
Style budget summary screen

## Narrative

As the person who uses Budget Planner
I want the monthly total, the incomplete-month notice, and the excluded-receipt count to look designed
So that checking my budget feels trustworthy and clear instead of reading raw numbers
