...
This project is indexed by Meridian as **budget-planner** (0 symbols, 0 relationships, 0 execution flows). Use the Meridian MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `meridian://repo/budget-planner/context` | Codebase overview, check index freshness |
| `meridian://repo/budget-planner/clusters` | All functional areas |
| `meridian://repo/budget-planner/processes` | All execution flows |
| `meridian://repo/budget-planner/process/{name}` | Step-by-step execution trace |
